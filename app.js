...
/* ============================================================
   🧰 HX — History Picker (Settings-style modal, scoped)
   ============================================================ */
.hx-overlay{
  position:fixed; inset:0; display:flex; align-items:center; justify-content:center;
  background:rgba(0,0,0,.45); z-index:9999; animation: fadeIn .25s ease;
}
.hx-box{
  position:relative;
  ...
  text-align:center;
  box-shadow: 0 0 40px rgba(0,120,255,.30);
  animation: popIn .22s ease;
}
.hx-head{ margin-bottom:8px; }
.hx-title{ margin:0; font-weight:800; color:#0078ff; letter-spacing:.3px; }
.hx-sub{ margin:4px 0 0; font-size:12px; color:#777; }

.hx-close{
  position:absolute; right:10px; top:8px;
  background:none; border:none; font-size:20px; cursor:pointer; color:#555;
}
.hx-close:hover{ color:#000; }

.hx-body{ margin-top:8px; }
...
.hx-row:hover{
  ...
  box-shadow: 0 6px 14px rgba(0,120,255,.10);
}
.hx-week{ text-align:left; font-weight:600; }
.hx-hours{ font-weight:800; color:#111; }
.hx-arrow{ color:#0078ff; font-weight:800; padding-left:4px; }

.hx-back{
  display:inline-flex; align-items:center; gap:6px;
  color:#0078ff; background:#fff;
  border:2px solid rgba(0,120,255,.2);
  border-radius:8px; padding:6px 10px; font-weight:600;
  cursor:pointer; margin: 2px 0 10px;
}
.hx-back:active{ transform: translateY(1px); }

.hx-table{ width:100%; border-collapse:collapse; font-size:14px; }
.hx-table th{
  text-align:left; color:#0078ff;
  border-bottom:2px solid rgba(0,120,255,.15);
  padding:6px 4px;
}
.hx-table td{
...
.hx-total{ text-align:right; font-weight:700; color: var(--red, #e60000); margin-top:10px; }
